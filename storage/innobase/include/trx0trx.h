...
struct trx_t {
  ...
  trx_id_t cts; /*!< transaction cts */

  trx_id_t updated_max_cts; /*!< the max updated cts */

  bool is_rollback_finished; /*!< whether transaction is rollback finished*/

  bool in_setting_cts; /*!< whether transaction is in setting cts stage*/
