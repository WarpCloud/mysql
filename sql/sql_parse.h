...
/* record the global oldest sts */
extern std::atomic<unsigned long long> global_m_sts;
...
/** return value of function parse_sts_hint
...
#define STS_TOO_SMALL_ERROR (1)
#define TSO_IS_CLOSED_ERROR (2)
#define PARSE_STS_HINT_RETURN (0)
