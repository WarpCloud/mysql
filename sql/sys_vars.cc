...
#include "my_io.h"
#include "my_macros.h"
#include "my_sm4.h"  // my_sm4_opmode_names
...
// WARP-59312 for jdbc 5.1.xx compatibility
...
static Sys_var_enum Sys_block_encryption_mode_sm4(
    "block_encryption_mode_sm4", "mode for SM4_ENCRYPT/SM4_DECRYPT",
    HINT_UPDATEABLE SESSION_VAR(my_sm4_mode), CMD_LINE(REQUIRED_ARG),
    my_sm4_opmode_names, DEFAULT(my_sm4_ecb));
...
static Sys_var_ulong Sys_query_cache_size(
        "query_cache_size",
        "Mock query_cache_size for jdbc 5.1.xx compatibility. "
        "This variable is deprecated and will be removed in a future release.",
...
static Sys_var_enum Sys_query_cache_type(
        ...
        ON_CHECK(nullptr), ON_UPDATE(NULL), DEPRECATED_VAR(""));

static const char *encryption_algorithm_name[] = {"NONE", "AES", "KEYRING", "SM4", 0};

static Sys_var_enum Sys_encryption_algorithm(
    "encryption_algorithm",
    "Select encryption algorithm to encrypt table space. [AES, SM4]",
    READ_ONLY GLOBAL_VAR(opt_encryption_algorithm), CMD_LINE(OPT_ARG),
    encryption_algorithm_name, DEFAULT(1));
