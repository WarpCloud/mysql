...
class XA_prepare_log_event : public binary_log::XA_prepare_event,
 ...
 public:
  ...
  XID get_xid() {
    XID xid;
    xid.set_format_id(my_xid.formatID);
    xid.set_gtrid_length(my_xid.gtrid_length);
    xid.set_bqual_length(my_xid.bqual_length);
    xid.set_data(my_xid.data, my_xid.gtrid_length + my_xid.bqual_length);
    return xid;
  }
  #endif
